...
def gera(id_usuario, atrs, admin):
  """
  Retorna um bloco "<table>... </table>" 
  contendo os dados de um usuário.  
  ...
  Se {id_usuario} é {None}, retorna uma tabela de campos adequada para cadastrar novo usuário.
  ...
  {id_usuario}, que supostamente já existe. O identificador será visível
  ...
  """
  return html_bloco_dados_de_usuario_IMP.gera(id_usuario, atrs, admin)
