...
def gera(vid, usr, mostra_usr, edita_titulo):
  ...
  Em vez do atributo 'usr' do vídeo, a tabela incluirá um campo com nome 'id_usr'
  ...
  de {None}. O campo 'id_usr' da tabela será readonly e hidden. Os campos
  ...
  Se o vídeo já existe ({vid != None}), o campo 'id_usr' da tabela
