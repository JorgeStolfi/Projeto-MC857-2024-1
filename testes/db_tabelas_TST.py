...
assert usr1 == db_tabelas.identificador_para_objeto(usr1_id)
...
assert ses1 == db_tabelas.identificador_para_objeto(ses1_id)
...
assert vid1 == db_tabelas.identificador_para_objeto(vid1_id)
