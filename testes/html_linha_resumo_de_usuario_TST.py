...
def testa_html_linha_resumo_de_usuario(rot_teste, *args):
...
testa_html_linha_resumo_de_usuario("TUSER1",  usr1)
testa_html_linha_resumo_de_usuario("TUSER2",  usr2)
testa_html_linha_resumo_de_usuario("TUSER5",  usr5)
