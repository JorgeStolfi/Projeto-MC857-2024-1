...
def testa_comando_ver_sessao(rot_teste, *cmd_args):
...
testa_comando_ver_sessao("uso_comum", ses1, {'sessao': 'S-00000001'})

# Cliente tentando acessar sessão que não e dele:
testa_comando_ver_sessao("acesso_invalido", ses1, {'sessao': 'S-00000003'})
