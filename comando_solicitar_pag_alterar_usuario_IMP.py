...
def processa(ses, cmd_args):
  ...
  if ses == None or not obj_sessao.aberta(ses):
    ...
    if cmd_args == {} or cmd_args['id_usr'] == None :
      # O parâmetro 'id_usr' do comando nao foi especificado; supõe que é o dono da sessao:
      usr = usr_ses
      id_usr = obj_usuario.obtem_identificador(usr)
    elif cmd_args['id_usr'] != None:
      # O parâmetro 'id_usr' foi especificado; obtém dados do do dito cujo.
