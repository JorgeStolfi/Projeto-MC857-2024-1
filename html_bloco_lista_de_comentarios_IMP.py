...
def gera(com_ids, mostra_autor, mostra_video, mostra_pai, mostra_nota):
  ...
  cabecalhos = html_linha_resumo_de_comentario.gera(None, mostra_autor, mostra_video, mostra_pai, mostra_nota)
  ...
  for com_id in com_ids:
    ...
    res_campos = html_linha_resumo_de_comentario.gera(com, mostra_autor, mostra_video, mostra_pai, mostra_nota)
