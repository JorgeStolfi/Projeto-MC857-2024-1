...
def gera(com_ids, mostra_autor, mostra_video, mostra_pai, mostra_nota, forcar_mostrar_texto):

  # Linhas da tabela: uma lista de listas de fragmentos HTML:
  linhas = []

  cabecalhos = html_linha_resumo_de_comentario.gera(None, mostra_autor, mostra_video, mostra_pai, mostra_nota, forcar_mostrar_texto)
  ...
  for com_id in com_ids:
    ...
    res_campos = html_linha_resumo_de_comentario.gera(com, mostra_autor, mostra_video, mostra_pai, mostra_nota, forcar_mostrar_texto)
